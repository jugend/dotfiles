...
function setup() {
  for file in {aliases,bash_profile,bash_prompt,bashrc,functions,git_completion,gitconfig,gitignore,inputrc,node-inspectorrc,slate,tmux.conf,vimrc,vimrc.bundles}; do
