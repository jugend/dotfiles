...
vim.keymap.set('n', '<leader>rc', ReloadConfig, { desc = 'Reload init.lua config', noremap = true, silent = true })
...
--   require('neo-tree').toggle() -- Toggle Neo-tree
--   require('neo-tree.sources.file_system').focus() -- Focus on the file system
--   require('neo-tree').open() -- Open Neo-tree if it's not already open
--   -- local file_path = vim.fn.expand '%:p' -- Get the current file path
--   -- require('neo-tree.sources.file_system').navigate_to(file_path) -- Select the file in Neo-tree
-- end)
